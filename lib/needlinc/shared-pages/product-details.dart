...
class ProductDetailsPage extends StatefulWidget {
  ...
  ProductDetailsPage(
      {super.key, required this.userDetails, required this.productDetails, required this.data});
...
class _ProductDetailsPageState extends State<ProductDetailsPage> {
  ...
  String profilePicture = "";//holds the Image Url of the latest comment to be displayed
    ...
    FirebaseFirestore.instance
      ...
      if (documentSnapshot.exists) {
        ...
        if (data != null && data.containsKey('productDetails')) {
          Map<String, dynamic> productDetails = data['productDetails'] as Map<String, dynamic>;

          if (productDetails.containsKey('comments')) {
            List<dynamic> comments = productDetails['comments'] as List<dynamic>;
  ...
  void initState() {
    ...
    listenForComments();
    phoneNumber = getPhoneNumber(context, widget.userDetails!['userId']);
    super.initState();
  }
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                Text(
                                 addCommas("₦${widget.productDetails!['price']}"),
                                  style: const TextStyle(
                                    fontSize: 18,
                                    color: NeedlincColors.blue1,
                                ...
                                InkWell(
                                  onTap: ()async {
                                     Map<String, dynamic>? userProfileDetails = await getUserDataWithUserId(widget.userDetails!['userId']);
                                    Navigator.of(context).push(
                                      MaterialPageRoute(
                                        builder: (context) => ChatScreen(
                                          ...
                                          nameOfProduct:
                                          widget.productDetails!['name'],
                                          myPhoneNumber: userProfileDetails!['phoneNumber'],
                                ...
                                InkWell(
                                  onTap: () {
                                    if (phoneNumber == null) {
                                      ...
                                      launch("telprompt:,$phoneNumber");
                                    }
                                  },
                                  child: Container(
                                      width: 30,
                                      height: 30,
                                      child: Icon(Icons.call, size: 15, color: NeedlincColors.white,),
                                      decoration: BoxDecoration(
                                          color: NeedlincColors.blue1,
                      ...
                      onTap: () {
                        Navigator.push(
                            ...
                            MaterialPageRoute(builder: (context) => CommentsPage(
                              ...
                              ownerOfPostUserId:widget.userDetails!['userId'],
                            )
                            )
                        );
                      },
