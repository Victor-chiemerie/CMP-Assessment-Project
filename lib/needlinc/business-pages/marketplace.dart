        ...
        // This is the AppBar
          ...
          body: isSearching
            ...
            gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
              crossAxisCount:  max(2, calculateCrossAxisCount(screenWidth, 4, 185)), // Ensure at least 2 columns
              mainAxisSpacing: 8.0,
              mainAxisExtent: 211,
            ),
                                      ...
                                      children:  [
                                        Container(
                                          ...
                                          child: ElevatedButton(
                                            style: ButtonStyle(
                                              backgroundColor: WidgetStatePropertyAll(NeedlincColors.blue1),
                                              foregroundColor: WidgetStatePropertyAll(NeedlincColors.white),
                                            ),
                                              child: Row(
                                                  children: [
                                                    Text('Buy', style: TextStyle(fontSize: 11, color: Colors.white)),
                                          ...
                                          Row(
                                              children:  [
                                                Container(
                                                  ...
                                                  child: ElevatedButton(
                                                    style: ButtonStyle(
                                                      backgroundColor:  WidgetStateProperty.all(NeedlincColors.blue1),
                                                      ...
                                                      onPressed: () async{
                                                        Map<String, dynamic>? userProfileDetails = await getUserDataWithUserId(userDetails!['userId']);
                                                        Navigator.of(context).push(
                                                          MaterialPageRoute(
                                                            builder: (context) => ChatScreen(
                                                              myProfilePicture: myProfilePicture,
                                                              ...
                                                              otherUserCategory: userProfileDetails['userCategory']
                                                            ),
                                                          ),
                                                        );
                                                      }
